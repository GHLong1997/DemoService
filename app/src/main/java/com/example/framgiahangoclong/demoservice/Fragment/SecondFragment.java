...
public class SecondFragment extends Fragment implements View.OnClickListener, OnDataChangeListener{
    ...
    public void onStart() {
        ...
        Log.d("hahaha", "onStart Second Fragment: ");
    }
    ...
    public void onStop() {
        ...
        Log.d("hahaha", "onStop Second Fragment: ");
        super.onStop();
    }
